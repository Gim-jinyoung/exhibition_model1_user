...
<!-- 공통 CSS -->
<link rel="stylesheet" type="text/css" href="http://localhost/html1_prj/common/css/main_20220321.css"/>
<style type="text/css">
...
6. 이용자 보호 및 부정 이용 방지: 개인위치정보주체 또는 이동성 있는 기기의 위치를 이용하여 권한없는 자의 비정상적인 서비스 이용 시도 등을 차단합니다.
 ...
 <div align="center">
  ...
  <input type="submit" class="btn btn-warning btn-block btn-lg" value="동의"><input type="reset" value="비동의" class="btn btn-warning btn-block btn-lg">
  <br/>
 </div>
</div>
</form>
